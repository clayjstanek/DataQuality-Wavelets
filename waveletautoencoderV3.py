...
plot_model(autoencoder, to_file='C:\\Users\cstan\Documents\CooperStandard\\tutorials\deepthinq-wavelets\\autoencoder_wavelet_coherence.png',
...
checkpoint = ModelCheckpoint(
    filepath='autoencoder2D_checkpoint.h5',  # Specify the file path where the model will be saved
...
autoencoder.save('autoencoder_2D_waveletcoherence102823.h5')
#sys.exit(0)
...
#train_history = autoencoder.fit(x_train_tensor, x_train_tensor, epochs=50, batch_size=16, shuffle=True,
#                validation_data=((x_test_tensor), (x_test_tensor)), callbacks=[checkpoint]) #validation_data=(val_images, val_images))
train_history = autoencoder.fit(x_train_tensor, x_train_tensor, epochs=50, batch_size=8, 
