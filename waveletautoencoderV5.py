...
logging.basicConfig(
    ...
    filename= p.joinpath('logs', 'waveletautoencoderV110823.log'),
...
plot_model(autoencoder, to_file=p.joinpath('autoencoder_wavelet_coherenceWin11.png'),
...
checkpoint = ModelCheckpoint(
    filepath= p.joinpath('autoencoder2D_checkpointWin11.h5'),  # Specify the file path where the model will be saved
...
autoencoder.save(p.joinpath('autoencoder_2D_waveletcoherence110923final.h5'))
sys.exit(0)
